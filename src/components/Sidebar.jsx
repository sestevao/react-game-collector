...
import { getUnseenNotificationsCount } from '../utils/api';
...
const Sidebar = () => {
  ...
  return (
    <aside className="w-64 shrink-0 hidden md:flex flex-col py-6 px-4 bg-white dark:bg-gray-900 border-r border-gray-200 dark:border-gray-800 text-gray-900 dark:text-gray-100 min-h-screen">
      
      <div className="mb-10 px-2">
        <Link to="/" className="flex items-center gap-2 mb-8 group">
          <div className="p-2 bg-indigo-600 rounded-lg group-hover:bg-indigo-700 transition shadow-lg shadow-indigo-500/30">
